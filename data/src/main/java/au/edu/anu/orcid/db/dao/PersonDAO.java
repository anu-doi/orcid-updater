 ...
 *
 * <p>Data Access Object Interface for the Person class</p>
 *
...
public interface PersonDAO extends GenericDAO<Person, Long>, ExtIdDAO<Person> {
	/**
	 * Get the person by their university id
	 * 
	 * @param uniId The persons university id
	 * @return The found person
	 */
	public Person getPersonByUniId(String uniId);
	
	/**
	 * Get the pesron by their university id, and load their publications
	 * 
	 * @param uniId THe persons university id
	 * @return The found person
	 */
