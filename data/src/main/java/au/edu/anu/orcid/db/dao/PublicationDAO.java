 ...
 *
 * <p>Data Access Object Interface for the Publication class</p>
 *
...
public interface PublicationDAO extends GenericDAO<Publication, Long>, ExtIdDAO<Publication> {
	/**
	 * Find the publications where the person has the given external identifier
	 * 
	 * @param externalIdentifier The external identifier to find
